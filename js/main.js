...
(function () {
  ...
  function renderWebCard(p) {
    ...
    const live = p.live ? '<span class="demo-status live"><i></i>Live</span>' : '<span class="demo-status">视频</span>';
    const hasUrl = p.url && p.url !== "#";
    const typeLabel = p.live === false ? "视频演示" : "网页 Demo";
    const preview = p.live && hasUrl
      ...
      : '<div class="demo-preview demo-preview-static"><div class="demo-preview-fallback">视频演示</div></div>';
